...
export default function SearchLocation(props: { onSearch: (latLng?: any[] | null, searchText?: string | null) => void }) {
                    ...
                    input: {
                        endAdornment:
                            <InputAdornment position="end">
                                <IconButton onClick={handleClear} edge="end" sx={{ visibility: debouncedValue ? "visible" : "hidden" }}>
                                    <CloseIcon />
                                </IconButton>
                                {loading ? (
                                    <IconButton edge="end">
